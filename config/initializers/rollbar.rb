Rollbar.configure do |config|
  ...
  # Normally would have this in an Environment file.
  # Instead, for this demo app, I'm leaving it here :-)
  #
  config.access_token = 'f8eea9bb809e4772b66220e42b758ffd'

  # Pop off Rollbars into the background job
  #
